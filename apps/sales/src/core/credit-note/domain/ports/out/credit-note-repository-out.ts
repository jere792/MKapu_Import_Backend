...
export interface ICreditNoteRepositoryPort {
    ...
    create(creditNote: CreditNote, queryRunner?: QueryRunner): Promise<CreditNote>;
    getNextCreditNoteNumberWithLock(serie: string, queryRunner: QueryRunner): Promise<number>;
}