...
import { ExportCreditNoteQueryService } from './application/service/query/export-credit-note-query.service';

@Module({
  imports: [
    TypeOrmModule.forFeature([CreditNoteOrmEntity, CreditNoteItemOrmEntity]),
  ...
  providers: [
    ...
    {
      provide: 'IExportCreditNoteQueryPort',
      useClass: ExportCreditNoteQueryService,
    },
  ],
