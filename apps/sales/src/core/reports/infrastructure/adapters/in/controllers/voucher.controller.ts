...
export class VoucherController {
    ...
    async exportExcel(@Query() filters: GetVoucherFilterDto, @Res() res: Response) {
        ...
        res.setHeader('Content-Type', 'application/vnc.openxmlformats-officedocument.spreadsheetml.sheet');
