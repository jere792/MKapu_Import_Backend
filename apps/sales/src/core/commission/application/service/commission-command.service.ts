...
import { GenerateCommissionPayload, ICommandCommissionRepositoryPortIn } from '../../domain/ports/in/comission-repository.port-in';
...
export class CommissionCommandService implements ICommandCommissionRepositoryPortIn {
  ...
  async updateRule(id: number, dto: CreateCommissionRuleDto): Promise<CommissionRule> {
  ...
  // ── Generación automática al emitir comprobante ───────────────────────────
