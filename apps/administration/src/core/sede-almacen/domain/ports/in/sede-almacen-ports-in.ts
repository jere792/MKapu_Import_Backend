...
export interface ISedeAlmacenCommandPort {
  assignWarehouseToSede(dto: AssignWarehouseToSedeDto): Promise<SedeAlmacenResponseDto>;
  reassignWarehouseToSede(dto: AssignWarehouseToSedeDto): Promise<SedeAlmacenResponseDto>; 
