...
export class HeadquarterRestController {
   ...
   async registerHeadquarter(
      ...
      const headquarter = await this.headquartersCommandService.registerHeadquarter(registerDto);
   ...
   async updateHeadquarter(
      ...
      const updatedHeadquarter = await this.headquartersCommandService.updateHeadquarter(fullUpdateDto);
   ...
   async changeHeadquarterStatus(
      ...
      const updatedHeadquarter = await this.headquartersCommandService.changeHeadquarterStatus({
         id_sede: id,
   ...
   async deleteHeadquarter(
      ...
      const deletedHeadquarter = await this.headquartersCommandService.deleteHeadquarter(id);
   ...
   @Get()
   async listHeadquarters(@Query() filters: ListHeadquartersFilterDto): Promise<HeadquartersListResponse> {
